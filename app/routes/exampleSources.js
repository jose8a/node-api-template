// =================================================================
// '/example/'             -- Returns all stories available from all tech sources
// '/example/ex1'          -- Returns data for ex1 sub-path
// '/example/ex2'          -- Returns data for ex2 sub-path
// '/example/ex3'          -- Returns data for ex3 sub-path
//
// =================================================================
let pathBase = 'example';

module.exports = function(router) {
  // get a collection of all my available stories from all sources
  router.get('/',  (req, res, next) => {
    console.log("BASEPATH - path: `/${pathBase/`");
    res.status(200).json({ data: `hello from ${pathBase}` } );
  });
